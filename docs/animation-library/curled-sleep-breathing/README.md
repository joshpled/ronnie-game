...
[Open the preview](index.html). Josh approved implementation of this isolated motion study on 2026-09-14. The breathing candidate still awaits visual approval; it is not promoted into the approved sheet or bedtime sequence.
