...
try {
  ...
  let time = reducedMotion.matches ? 800 : 0;
  ...
  function paint() {
    ...
    phase.textContent = `${step.phase} · ${(time / 1000).toFixed(1)} / 2.4 s`;
  ...
  // Avoid skipping through a cycle after switching apps or browser tabs.
